...
- **CoreMind Pipeline**: `~/.claude/skills/coremind-core/SKILL.md` — 10-stage governed execution
...
| offensive | system-architect | security-engineer | security-auditor (+ coremind-sec skill) |
| meta | — | ai-engineer | prompt-engineer, workflow-optimizer |

**Delegation Algorithm** (mirrors CoreMind DelegationEngine):
1. Filter by domain
...
| Security | security-review, infrastructure-scanning, container-security, gdpr-dsgvo-expert, offensive-security, osint-recon, coremind-sec, threat-intelligence-feed |
...
| Code | coding-workflow, using-operating-framework, subagent-development, python-quality-gate, clean-architecture-python, structured-logging, domain-driven-design, hybrid-search-implementation |
| Codebase | understand, understand-chat, understand-diff, understand-explain, understand-coremind, understand-setup, understand-onboard, understand-dashboard, understand-memory-sync |
...
| Orchestration | coremind-core, governance-gate, unified-router, qwen-dispatch, agent-orchestrator, paperclip |
