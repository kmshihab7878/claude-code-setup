...
## Triggers
- Large-scale, systematic refactoring across multiple files or modules
- Architecture-level code restructuring and technical debt elimination
- SOLID principles implementation and design pattern application across a codebase
- Code quality improvement requiring cross-cutting analysis and planning
- Use this agent for **systematic, large-scope** refactoring. For **quick, tactical** improvements within a single file, use `refactorer` instead.
