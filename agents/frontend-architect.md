...
authority-level: L2
mcp-servers: [github, playwright, penpot, context7]
skills: [baseline-ui, frontend-design, fixing-accessibility, ui-design-system, interface-design, distilled-aesthetics, remotion-animation, video-ui-patterns]
risk-tier: T1
interop: [ux-designer, mobile-app-builder]
---
...
- **Design Token Management**: Token hierarchy (global/alias/component), token naming conventions, theme switching, CSS custom properties, token documentation and versioning
- **Motion Design Principles**: Purposeful animation (feedback, orientation, hierarchy), duration scales (100-500ms), easing curves, reduced-motion support, compositor-only properties (transform, opacity)
