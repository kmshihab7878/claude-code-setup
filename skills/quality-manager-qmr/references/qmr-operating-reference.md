# QMR Operating Reference

Detailed QMR matrices, templates, checklists, workflows, and quick references
extracted from `../SKILL.md`. Load this file when preparing formal management
review material, KPI frameworks, objective plans, culture assessments, or
compliance oversight artifacts.
...
1. Schedule management review, minimum annually and often quarterly or
   semi-annually.
2. Notify required attendees at least 2 weeks prior.
...
8. Validate that all required inputs were reviewed and decisions documented with
...
8. Validate each KPI has owner, target, data source, and escalation criteria.
...
8. Validate each objective is measurable, has owner, target, and timeline.
...
### Annual Culture Assessment Workflow

1. Design or select quality culture survey instrument.
2. Define survey population.
...
8. Validate response rate over 60% and action plan covers bottom 3 scores.
...
8. Validate all applicable requirements mapped and no expired registrations.
...
| Tool | Purpose | Usage |
|---|---|---|
| `scripts/management_review_tracker.py` | Track review inputs, actions, metrics | `python management_review_tracker.py --help` |
...
| Document | Content |
|---|---|
| `references/management-review-guide.md` | ISO 13485 Clause 5.6 requirements, input/output templates, action tracking |
| `references/quality-kpi-framework.md` | KPI categories, targets, calculations, dashboard templates |

### Quick Reference: Management Review Inputs
...
### Quick Reference: Management Review Outputs
