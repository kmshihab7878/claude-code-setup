...
description: >
  ...
  improves them during use, and delivers CoreMind decisions via Telegram/Discord/Slack.
...
- **Multi-platform delivery**: Send CoreMind decisions to Telegram, Discord, or Slack
