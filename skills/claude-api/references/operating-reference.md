# Claude API Operating Reference

Detailed language routing, surface selection, architecture, model, thinking, compaction, reading-guide, WebFetch, and pitfalls material extracted from `SKILL.md` to keep the skill body concise.
