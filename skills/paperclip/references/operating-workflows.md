# Paperclip Operating Workflows

Detailed workflow, comment, planning, endpoint, import/export, search, and self-test material extracted from `SKILL.md` to keep the skill body focused on heartbeat execution.
