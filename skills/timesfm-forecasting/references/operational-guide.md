# TimesFM Operational Guide

Detailed preflight, installation, examples, configuration, scripts, model/version, resource, quality, mistake, and validation material extracted from `SKILL.md` to keep the skill body concise.
