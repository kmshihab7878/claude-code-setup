# Python Code Patterns — n8n Code Node

Production-tested patterns, full examples. The minimal rules and pattern names live in `SKILL.md`; this file holds the long examples.
...
See [common-patterns.md](common-patterns.md) for 10 detailed Python patterns including grouping, deduplication, type coercion, and edge cases.

## Standard Library — most useful module quick reference
