...
| Tag | Skills |
|-----|--------|
| process | operating-framework, using-operating-framework, executing-plans, branch-finishing, coding-workflow, research-methodology, subagent-development, git-worktrees |
...
| meta | using-operating-framework, skill-creator, skill-architect |
...
| codebase | understand, understand-chat, understand-diff, understand-explain, understand-coremind, understand-setup, understand-onboard, understand-memory-sync, understand-dashboard |
