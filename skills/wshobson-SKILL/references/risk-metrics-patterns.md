# Risk Metrics Implementation Patterns

Full implementation examples extracted from `SKILL.md` to keep the operating guide concise while preserving reusable code for risk calculations.
