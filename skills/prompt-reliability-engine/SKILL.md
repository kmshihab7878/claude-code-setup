...
- Tasks already governed by coremind-core pipeline (unless auditing the pipeline prompts themselves)
...
| Mode 6 (Workflow Architect) | `coremind-core` pipeline, `operating-framework` |
