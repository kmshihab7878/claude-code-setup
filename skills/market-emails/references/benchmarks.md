# Industry benchmarks (Phase 5 detail)

Open / click / conversion rate benchmarks by industry (SaaS, E-commerce, Agency, Education, Health, Finance, Media). SKILL.md keeps a summary range; this file holds the per-industry table for inclusion in EMAIL-SEQUENCES.md output.
