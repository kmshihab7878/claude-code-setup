# Sequence templates (Phase 3 detail)

Full per-email templates for the three core sequences: Welcome (5–7 emails), Cold Outreach (3–5 emails), Cart Abandonment (3–4 emails). Each email lists send timing, subject line, body purpose, CTA. SKILL.md keeps the sequence-type index; this file holds the full ready-to-customize templates.
