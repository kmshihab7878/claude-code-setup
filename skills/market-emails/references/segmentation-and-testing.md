# Segmentation and A/B testing (Phase 4 detail)

Full 6-row segmentation table (Behavior / Engagement / Source / Stage / Interest / Value) and the A/B testing recommendations + 4-level testing hierarchy. SKILL.md keeps the segmentation-bases list and testing hierarchy summary; this file holds the full tables and variant lists.
