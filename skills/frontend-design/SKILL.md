...
When using shadcn/ui (React + Tailwind):
...
### Cross-References
- **responsive-design** skill: Mobile-first responsive patterns
- **baseline-ui** skill: Tailwind defaults and typography
- **FRONTEND_PATTERNS.md**: shadcn architecture deep dive
