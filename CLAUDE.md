...
## Identity
- **User**: Repository owner (<contributor>)
...
7. **Root cause first** — No fixes without investigation and evidence. State root cause before fixing. (Operating Framework)
8. **Evidence first** — No "done" without proof. Show test output, logs, or build results. (Operating Framework)
9. **Approval first** — No coding from unapproved brainstorm/spec. Get explicit user approval. (Operating Framework)
10. **1% rule** — If even 1% chance a skill applies, check it. Don't rationalize skipping. (Operating Framework)
...
## CoreMind-Mirrored Architecture
...
| CoreMind Pipeline | `~/.claude/skills/coremind-core/SKILL.md` | 10-stage governed execution pipeline |
...
- **178 skills** across 27 domains (process, testing, git, API, infra, AI, security, frontend, docs, trading, codebase, C-suite, marketing, product, business, k8s, offensive, meta, UI cloning, project scaffolding, video, interface-design, marketing-automation, n8n-automation, DDD-architecture, recipes, recall/memory) — frontend domain includes: framer-motion-patterns, responsive-design, web-artifacts-builder, algorithmic-art; meta domain includes: **ultrathink**
- **21 custom + 31 SC + 15 BMAD** commands (67 total) — custom includes: **/ultraplan** (15-stage sovereign pipeline)
...
"design", "architect", or "implement" a non-trivial task — execute the **CoreMind CoreMind
