...
| `skills/coremind-sec` | 98 | CORE | Distinctive autonomous security ecosystem |
...
| `skills/understand-coremind` | `understand-chat` | Specific-variant that duplicates general chat skill |
...
- **Process skills**: `redacted-private-skill`, `project-template`, `using-operating-framework`, `quality-manager-qmr`, `para-memory-files`, `recipe`, `agent-evaluation`, `anti-ai-writing`, `confidence-check` (has .py + .ts), `context-budget-audit` — SUPPORTING.
...
| `commands/coremind-sec.md` | 48 | CORE | Invokes coremind-sec skill |
...
| 7 | `agents/REGISTRY.md` | 416 | CORE | **Operational + Positioning** — central dispatch table, proves the CoreMind-mirrored architecture |
| 8 | `skills/coremind-core/SKILL.md` | 322 | CORE | **Operational + Extraction** — 10-stage governed pipeline, standalone skill candidate |
...
| 15 | `skills/coremind-sec/SKILL.md` | 98 | CORE | **Positioning + Extraction** — autonomous security ecosystem |
...
- Top-20 skills per CLAUDE.md (coremind-core, governance-gate, operating-framework, coding-workflow, moyu, prompt-reliability-engine, n8n, etc.)
...
| CoreMind-sec | `skills/coremind-sec/` + `commands/coremind-sec.md` | Yes |
...
| CoreMind-Core governance | `skills/{coremind-core,governance-gate}/` + `agents/REGISTRY.md` | Yes |
