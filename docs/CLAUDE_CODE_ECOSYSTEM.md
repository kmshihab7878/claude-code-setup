...
- Operator already has extensive custom CLAUDE.md — zcf generation may conflict
...
```json
{
  "mcpServers": {
    "serena": {
      ...
      "env": {
        "PROJECT_ROOT": "/Users/redacted-username/CoreMind-FRESH"
      }
    }
  }
}
...
1. **Gap analysis**: Does it fill a capability Operator doesn't have?
