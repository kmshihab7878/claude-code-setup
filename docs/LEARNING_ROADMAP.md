...
| 5. Agent Systems | Multi-agent, tool use, planning, memory | AG2 docs, CoreMind architecture, agent-orchestration skill | Ongoing |
...
|-------|----------------|-----------------|----------|
| AI/ML | finance-ml, rag-patterns, claude-api | data-analyst, python-expert | CoreMind, FINCALC |
| LLM Apps | rag-patterns, agent-orchestration | deep-research, learning-guide | CoreMind LLM |
| DS/Algo | coding-workflow | python-expert | General |
| DevOps | devops-patterns, security-review | infra-engineer, ci-cd-engineer | CoreMind deploy |
