...
| Operator Component | Data Platform Integration |
|-----------------|--------------------------|
...
### CoreMind Integration
- **CoreMind PostgreSQL**: Direct connection for Metabase/Superset dashboards
- **CoreMind API**: Airbyte connector for data pipeline
- **CoreMind knowledge**: Feed analysis results into knowledge system
