# Operator's Claude Code Architecture
...
| Active Projects | CoreMind-FRESH, FINCALC AI, Financial Intelligence Dept, SuperClaude |
...
│   ├── baseline-ui/
│   ├── bmad/
│   ├── branch-finishing/        # Operating Framework
...
│   ├── doc-coauthoring/
│   ├── document-handling/
│   ├── executing-plans/         # Operating Framework
│   ├── fixing-accessibility/
│   ├── fixing-metadata/
│   ├── fixing-motion-performance/
│   ├── frontend-design/
│   ├── git-workflows/
│   ├── git-worktrees/           # Operating Framework
│   ├── mcp-builder/
│   ├── pdf/
│   ├── receiving-code-review/   # Operating Framework
│   ├── research-methodology/
│   ├── security-review/
│   ├── skill-architect/
│   ├── skill-creator/
│   ├── subagent-development/    # Operating Framework
│   ├── test-driven-development/ # Operating Framework
│   ├── testing-methodology/
│   ├── ui-ux-pro-max/           # 50+ styles, 97 palettes, BM25 search
│   ├── using-operating-framework/      # Operating Framework meta-skill (always active)
│   ├── verification-before-completion/ # Operating Framework
│   ├── webapp-testing/
│   └── xlsx/
│
...
| Command | Purpose | Operating Framework Gate |
|---------|---------|-------------------|
...
|----------|--------|-------|
| **Operating Framework** | using-operating-framework, test-driven-development, verification-before-completion, executing-plans, subagent-development, git-worktrees, branch-finishing, receiving-code-review | 8 |
...
### Operating Framework Cross-References

| Skill | Enforces Non-Negotiable | Modifies Commands |
|-------|-------------------------|-------------------|
| using-operating-framework (meta) | All 6-10 | Activates all below |
...
| `architecture.md` | Reference | System overviews (CoreMind-FRESH, FINCALC AI) |
...
- **Key modules**: `src/coremind/gaos/`, `src/coremind/security/`, `src/coremind/core/contracts/`, `src/coremind/agents/`
...
| 6 | Test first | test-driven-development skill (Operating Framework) |
| 7 | Root cause first | `/debug` command (+root cause gate), root-cause-analyst agent |
| 8 | Evidence first | verification-before-completion skill (Operating Framework) |
| 9 | Approval first | `/sc:brainstorm` (+approval gate), executing-plans skill |
| 10 | 1% rule | using-operating-framework meta-skill (always active) |
