# Operating Framework Ultimate Operating Framework v1.0 — Reference Document
...
> agents, and MCP servers in Operator's environment.
...
- Requirements: Follow lane + Operating Framework gates
...
| 2 | Gate compliance | 100% | No Operating Framework gate violations |
...
| Micro-level gates | Meta-skill | `~/.claude/skills/using-operating-framework/SKILL.md` |
