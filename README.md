...
- **What could be pulled out as standalone products:** [`docs/EXTRACTABLE-PRODUCTS.md`](docs/EXTRACTABLE-PRODUCTS.md) — 10 self-contained extraction candidates (Elite Ops, self-evolution, /market, Hue, CoreMind-sec, react-bits, mcp-mastery, anti-ai-writing, n8n, CoreMind-Core governance).
